...
!
! Main program: BUFR_TRANMRMS
!   Prgmmr: Praveen Kumar           Org: EMC         Date: 2022-11-29
!
...
!      call w3tagb('BUFR_TRANSKYCOVR',2017,0313,0050,'NP22')
      call w3tagb('BUFR_TRANMRMS',2022,0313,0050,'NP22')

      print*
      print*, 'WELCOME TO BUFR_TRANMRMS - VERSION 09-15-2022'
      print*

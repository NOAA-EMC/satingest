...
!   PRGMMR: DONG             ORG: NP22        DATE: 2019-10-09
!
...
! 2019-09-18  Dong    Modified to handle processing of METOP-3 data.
! USAGE:
!   INPUT FILES:
...
!-----------------------------------------------------------------------
      call w3tagb('BUFR_TRANAVHRR',2019,0282,1450,'NP22')
      print *, ' '
      print *, '  WELCOME TO BUFR_TRANAVHRR - VERSION 10-09-2019'
      print *, ' '
...
!  -------------------------------------
      ...
      open(unit=37,form="formatted",status="old")
      read(37,'(5761I1)') lst
...
!  -------------------------------
      ...
      open(lu1b,recl=reclavh/rfac,access='direct',IOSTAT=ios,status='old')
...
!  ---------------------------------------------------------------
      ...
      elseif (jsat.eq.8) then                 ! NOAA-19 (P)
         ...
         write(stdout,*) '***WARNING:   reset satellite id from ', jsat0,&
                         ' to ',jsat
      elseif (jsat.eq.13) then                ! METOP-3 (M3)
         jsat0 = jsat
         jsat  =   5
         write(stdout,*) '***WARNING:   reset satellite id from ', jsat0,&
                         ' to ',jsat

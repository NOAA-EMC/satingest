...
#        path $USHsatingest.  Aborts with condition code 98 if
...
#                  $USHsatingest/ingest_process_onetype_neworbits.sh
...
#   $USHsatingest/ingest_process_onetype_neworbits.sh (except where
...
#                              $USHsatingest/bufr_tranjb.sh after all
#                              other processing is complete
#                                     -- or --
#                           2) executing $USHsatingest/bufr_tranjb.sh
...
#       $USHsatingest/ingest_process_onetype_neworbits.sh (some values 
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  ksh $USHsatingest/ingest_process_onetype_neworbits.sh
  err=$?
  ...
  ksh $USHsatingest/ingest_check_lapsed_data.sh $ORBITLIST.history

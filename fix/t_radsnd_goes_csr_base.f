...
#-----------------------------------------------------------------
      ...
      eval knumber=2
        ...
        eval DNCF1="$AWSDIR/ABI_L2_CSRF_BUFR/GOES-18/"
        eval DNCF2="$AWSDIR/ABI_L2_CSRF_BUFR/GOES-19/"

eval SNCF1="ABI-L2-CSRF-M6_v2r3_g18_s???????????????_e???????????????_c???????????????.bufr"
eval SNCF2="ABI-L2-CSRF-M6_v2r3_g19_s???????????????_e???????????????_c???????????????.bufr"

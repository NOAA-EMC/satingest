...
PDAFileLinks/NDE/OMPSTC/NPP/OMPS-TC_v4r5_npp_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/OMPSTC/J01/OMPS-TC_v4r5_j01_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/OMPSTC/N21/OMPS-TC_v4r5_n21_s???????????????_e???????????????_c???????????????.bufr"'}

...
PDAFileLinks/NDE/OMPS/OMPS-TC_v4r3_npp_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/OMPS/OMPS-TC_v4r3_j01_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/OMPS/OMPS-TC_v4r3_n21_s???????????????_e???????????????_c???????????????.bufr"'}

...
PDAFileLinks/NDE/ATMS/NPP/ATMS_v1r0_npp_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/ATMS/J01/ATMS_v1r0_j01_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/ATMS/N21/ATMS_v1r0_n21_s???????????????_e???????????????_c???????????????.bufr"'}

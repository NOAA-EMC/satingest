...
PDAFileLinks/PULL/BIN/ABI-L2-ASRF-M6_v2r3_g19_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/PULL/BIN/ABI-L2-ASRF-M6_v2r3_g18_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/PULL/BIN/ABI-L2-ASRF-M6_v2r3_g16_s???????????????_e???????????????_c???????????????.bufr"'}

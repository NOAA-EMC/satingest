...
export DNCF1="$AWSDIR/NUCAPS_C0431_BUFR/NOAA-20/"
export DNCF2="$AWSDIR/NUCAPS_C0431_BUFR/NOAA-21/"

eval SNCF1="NUCAPS-C0431_v4r0_j01_s???????????????_e???????????????_c???????????????.bufr"
eval SNCF2="NUCAPS-C0431_v4r0_n21_s???????????????_e???????????????_c???????????????.bufr"

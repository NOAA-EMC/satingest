...
PDAFileLinks/NDE/VIIRS_GHRSST/VIIRS-ACSPO-SST-ProbClear_v2r80_npp_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/VIIRS_GHRSST/VIIRS-ACSPO-SST-ProbClear_v2r80_j01_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/VIIRS_GHRSST/VIIRS-ACSPO-SST-ProbClear_v2r80_n21_s???????????????_e???????????????_c???????????????.bufr"'}

...
PDAFileLinks/NDE/OMPS/OMPS-NP_v4r5_n21_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/OMPS/OMPS-NP_v4r5_npp_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/OMPS/OMPS-NP_v4r5_j01_s???????????????_e???????????????_c???????????????.bufr"'}

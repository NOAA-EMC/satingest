...
PDAFileLinks/NDE/OMPSNP/NPP/OMPS-NP_v4r5_npp_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/OMPSNP/J01/OMPS-NP_v4r5_j01_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/OMPSNP/N21/OMPS-NP_v4r5_n21_s???????????????_e???????????????_c???????????????.bufr"'}

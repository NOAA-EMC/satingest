...
PDAFileLinks/NDE/AMSR2/AMSR3-MBT-89A_v1r0_ggw_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/AMSR2/AMSR3-MBT-89B_v1r0_ggw_s???????????????_e???????????????_c???????????????.bufr \
PDAFileLinks/NDE/AMSR2/AMSR3-MBT-LR_v1r0_ggw_s???????????????_e???????????????_c???????????????.bufr"'}
